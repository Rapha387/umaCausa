...
public class Campanha : Banco
{
    ...
    public void AtualizarDataDesbloqueioCampanha(int codigo, int gravidade)
    {
        List<Parametro> parametros = new List<Parametro>()
        {
            new Parametro ("pUsuario", codigo.ToString()),
        ...
        {
            Conectar();
            Executar("AtualizarDataDesbloqueioCampanha", parametros);
        }
        catch (Exception ex)
        {
    ...
    public void AprovarDenuncia(DateTime Data, int Denunciante, int Denunciado, int gravidade)
    {
        ...
        {
            Conectar();
            Executar("AprovarDenunciaCampanha", parametros);
        }
        catch (Exception ex)
        {
            throw new Exception(ex.Message);
        ...
        List<Parametro> parametros = new List<Parametro>()
    {
        ...
        {
            Conectar();
            Executar("RemoverDenunciaCampanha", parametros);
        }
        catch (Exception ex)
        {
            throw new Exception(ex.Message);
